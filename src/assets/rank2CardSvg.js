// Raw markup for streamline_rank2_card_no_dp.svg (see rank1GoldenCardSvg.js
// for why this is kept as XML + rendered via SvgXml instead of hand-copied
// into Svg/Path JSX like this app's other icons). Same layout as the rank 1
// card minus the crown, so the same crop-and-position approach applies —
// just with a tighter top bound since there's no crown to leave room for.
export const RANK2_CROP = { x: 72, y: 100, width: 456, height: 576 };
export const RANK2_CARD_SVG = `<svg xmlns="http://www.w3.org/2000/svg" width="600" height="700" viewBox="${RANK2_CROP.x} ${RANK2_CROP.y} ${RANK2_CROP.width} ${RANK2_CROP.height}" fill="none">
<defs>
  <linearGradient id="metal" x1="90" y1="90" x2="510" y2="620" gradientUnits="userSpaceOnUse">
    <stop stop-color="#B77CFF"/>
    <stop offset=".35" stop-color="#7C2CFF"/>
  ...
  <linearGradient id="bright" x1="180" y1="100" x2="430" y2="500" gradientUnits="userSpaceOnUse">
    ...
    <stop offset=".25" stop-color="#B77CFF"/>
    <stop offset=".65" stop-color="#7C2CFF"/>
  ...
  <radialGradient id="glow">
    <stop stop-color="#7C2CFF" stop-opacity=".25"/>
...
<rect x="98" y="124" width="404" height="438" rx="26" stroke="#B77CFF" stroke-opacity=".16"/>
...
<g filter="url(#smallGlow)">
  ...
  <text x="142" y="176" text-anchor="middle" font-family="Arial,Helvetica,sans-serif"
        font-size="30" font-weight="700" fill="#B77CFF">2</text>
</g>

<circle cx="300" cy="292" r="105" fill="#07070C" stroke="#7C2CFF" stroke-opacity=".45" stroke-width="5"/>
<circle cx="300" cy="292" r="100" stroke="url(#bright)" stroke-width="4" filter="url(#smallGlow)"/>
<circle cx="300" cy="292" r="91" stroke="#B77CFF" stroke-opacity=".18"/>
...
<g transform="translate(226 452)" filter="url(#smallGlow)">
  <path d="M0 10 L12 0 L28 3 L34 15 L22 29 L7 25 Z"
        fill="url(#bright)" stroke="#B77CFF" stroke-width="2"/>
...
<g filter="url(#glowFx)">
  ...
  <ellipse cx="300" cy="607" rx="155" ry="22" fill="#09080F" stroke="#B77CFF" stroke-width="3"/>
  <ellipse cx="300" cy="606" rx="130" ry="14" fill="#171021" stroke="#7C2CFF" stroke-opacity=".6" stroke-width="2"/>
</g>
</svg>`;

export default RANK2_CARD_SVG;
