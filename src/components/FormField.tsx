...
export type FormFieldIcon = 'user' | 'email' | 'lock' | 'phone';

const ICONS: Record<FormFieldIcon, typeof UserIcon> = {
  user: UserIcon,
  email: EmailIcon,
  lock: LockIcon,
  phone: PhoneIcon,
...
export function FormField({ label, placeholder, value, onChangeText, icon, secureTextEntry, editable = true, keyboardType, rightElement }: FormFieldProps) {
